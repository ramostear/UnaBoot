![](https://github.com/ramostear/UnaBoot-Pro/blob/master/src/main/resources/static/admin/img/una-logo-max.svg)
...
| 时间             | 版本号                           | 说明                                                         |
| ---------------- | ------------------------------ | ------------------------------------------------------------ |
|2020-04-04|v1.2.2|提供默认主题:卡特琳娜,修改文章字段校验规则|
|2020-03-20|v1.2.0|新版尤娜开源，改进主题解析方式，取消主题刷新；新增在线安装向导|
|2019-11-28|v1.0.0|尤娜博客基础版上线|
